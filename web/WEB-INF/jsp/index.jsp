            ...
            <div class="row-fluid" style="height:auto">
                ...
                <div class="col-xs-6" style="height: auto;">
                    ...
                    <table class="table formTable" style="margin-top: 5px">
                        ...
                        <tr><td style="text-align: right;font-size: 1.5em;">First Name :</td><td><sf:input type="text" path="firstName" id="firstName" class="form-control" /></td></tr>
                        <tr><td style="text-align: right;font-size: 1.5em;">Last Name :</td><td><sf:input type="text" path="lastName" id="lastName" class="form-control" /></td></tr>
                        <tr><td style="text-align: right;font-size: 1.5em;">Your Email :</td><td><sf:input type="text" path="email" id="email" class="form-control" /></td><td><img id="checkEmail" src="resources/images/282.gif"style="display:none"/></td></tr>
                        <tr><td style="text-align: right;font-size: 1.5em;">Password :</td><td><sf:input type="password" path="firstName" id="password" class="form-control" /></td></tr>
                        <tr><td style="text-align: right;font-size: 1.5em;">Confirm Password :</td><td><sf:input type="password" path="password" id="repeatPassword" class="form-control" /></td><td><img id="checkPassword" src=""style="display:none"/></td></tr>
                        <tr><td style="text-align: right;font-size: 1.5em;">I am :</td><td><sf:select path="gender" id="gender" class="form-control"><sf:option value="Male">Male</sf:option><sf:option value="Female">Female</sf:option></sf:select></td></tr>
                        <tr><td style="text-align: right;font-size: 1.5em;">Birthday :</td><td><sf:input type="text" path="birthday" id="birthday" class="form-control" /></td></tr>
                        <tr><td colspan="2" style="text-align: center"><button class="btn btn-info" id="signUpBtn">Sign Up <span class="glyphicon glyphicon-plus-sign"></span></button></td></tr>
                        </sf:form>
                     <tr>
